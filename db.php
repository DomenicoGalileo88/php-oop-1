...
$black_panther = new Movie('Black Panther', 'Adventures', '2018', 'it', 'https://cdn.shopify.com/s/files/1/2103/4063/products/BlackPanther_poster_06b76e17-9825-4789-8859-7d1dccf53b4a_1024x1024.jpg?v=1519668121');
$thor_ragnarock = new Movie('Thor: Ragnarok', 'Adventures', '2017', 'en', 'https://images-na.ssl-images-amazon.com/images/I/914fedeGZRL.jpg');
...
$movies = [
    ...
    new Movie('Doctor Strange', 'Adventures', '2016', 'ita', 'https://m.media-amazon.com/images/I/81Zlc0suPCL._SY550_.jpg'),
    ...
    new Movie('Black Panther', 'Adventures', '2018', 'it', 'https://cdn.shopify.com/s/files/1/2103/4063/products/BlackPanther_poster_06b76e17-9825-4789-8859-7d1dccf53b4a_1024x1024.jpg?v=1519668121'),
    new Movie('Thor: Ragnarok', 'Adventures', '2017', 'en', 'https://images-na.ssl-images-amazon.com/images/I/914fedeGZRL.jpg'),
    ...
    new Movie('Black Widow', 'Adventures', '2016', 'it', 'https://lumiere-a.akamaihd.net/v1/images/image_b97b56f3.jpeg?region=0%2C0%2C540%2C810'),
];
...
function FilterGenre($data, $genre)
{
 ...
 $filtered_movies = FilterGenre($movies, $genre);
